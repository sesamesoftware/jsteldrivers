...
public class XMLDriver2 extends CommonDriver2 {
   ...
   static {
      try {
         DriverManager.registerDriver(new XMLDriver2());
         // ##############for registration####################
//      try {
...
//              "License has been expired");
         ...
         throw new RuntimeException(
                 "[Relational Junction XML JDBC Driver] FATAL ERROR: Could not initialize XML driver. Message was: "
                         + e.getMessage());
      }
   }
