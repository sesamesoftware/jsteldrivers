...
import com.relationaljunction.jdbc.csv.h2.*;

public class CsvDriver2 extends CommonDriver2 {
  public static final String DEFAULT_CHARSET = null;
  private static final String PRODUCT_NAME = "Relational Junction CSV JDBC driver";
  ...
  private static final String URL_PREFIX = "jdbc:relationaljunction:csv:";
  ...
  // don't remove. This variable is for CsvDriverProperties class to be linked
  private final CsvDriverProperties driverProperties = null;
  ...
  protected Connection getConnection(java.util.Properties props) throws
      SQLException {
    return new CsvConnection2(this, props);
  }

  protected Connection getPersistentConnectionForJavaServers(java.util.
      Properties props) throws SQLException {
    return new PersistentCsvConnection2(this, props);
  }
  ...
  static {
    try {
      DriverManager.registerDriver(new CsvDriver2());
      // ##############for registration####################
//      try {
