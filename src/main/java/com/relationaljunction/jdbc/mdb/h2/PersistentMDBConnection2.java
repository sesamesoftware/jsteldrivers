...
public class PersistentMDBConnection2 extends MDBConnection2 {
  private final Logger log = LoggerFactory.getLogger("PersistentMDBConnection2");

  public PersistentMDBConnection2(CommonDriver2 driver, Properties props) throws
      SQLException {
    super(driver, props);
  }
