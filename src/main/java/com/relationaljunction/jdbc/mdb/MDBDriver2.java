...
public class MDBDriver2 extends CommonDriver2 {
  ...
  private static final String PRODUCT_NAME = "Relational Junction MDB JDBC driver";
  ...
  protected Connection getConnection(java.util.Properties props) throws
      SQLException {
    return new MDBConnection2(this, props);
  }

  protected Connection getPersistentConnectionForJavaServers(java.util.
      Properties props) throws SQLException {
    return new PersistentMDBConnection2(this, props);
  }
...
//              "License has been expired");
      ...
      throw new RuntimeException(
	  "[Relational Junction MDB JDBC Driver] FATAL ERROR: Could not initialize the DBF driver. Message was: "
	  + e.getMessage());
    }
  }
