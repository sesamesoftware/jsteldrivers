...
public class MDBPooledConnection2 implements PooledConnection {
   private MDBLogicalConnection2 logicalConn = null;
   private MDBConnectionPoolDataSource2 poolDS = null;
   private final Vector listeners = new Vector();
   private boolean closed = false;

   public MDBPooledConnection2(MDBConnectionPoolDataSource2 poolDS) {
      this.poolDS = poolDS;
   }
   ...
   synchronized public Connection getConnection() throws SQLException {
      ...
      if (logicalConn != null)
         return logicalConn;
      try {
         logicalConn = new MDBLogicalConnection2(this, poolDS.getProperties());
      } catch (Exception ex) {
