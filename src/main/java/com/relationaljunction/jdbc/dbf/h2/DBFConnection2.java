...
public class DBFConnection2 extends CommonConnection2 {
    public DBFConnection2(CommonDriver2 driver, Properties props) throws
            SQLException {
    ...
    protected StoreSchemaIF2 createSchema(Properties props) throws
            SQLException {
        DBFSchemaFactory dbfSchemaFactory = new DBFSchemaFactory();
        try {
            return dbfSchemaFactory.createSchema(this, props);
        } catch (StoreException ex) {
            throw new SQLException("Error while creating a DBF schema: " + ex.getMessage());
        }
    }
