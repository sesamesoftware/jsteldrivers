...
public class ComplexValueForeignKeyImpl extends ComplexValueForeignKey
{
  ...
  @Override
  public void updateMultiValue(SingleValue value) throws IOException {
    reset();
    getMultiValueInfo().updateValue(value);
  }
  
  @Override
  public void deleteMultiValue(SingleValue value) throws IOException {
    reset();
  ...
  @Override
  public void updateUnsupportedValue(UnsupportedValue value)
    throws IOException
  {
    reset();
  ...
  @Override
  public void deleteUnsupportedValue(UnsupportedValue value)
    throws IOException
  {
    reset();
