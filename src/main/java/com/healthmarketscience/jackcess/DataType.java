...
public enum DataType {
  ...
  private static final Map<Integer, DataType> SQL_TYPES = new HashMap<Integer, DataType>();
  /** Alternate map of SQL types to Access data types */
  private static final Map<Integer, DataType> ALT_SQL_TYPES = new HashMap<Integer, DataType>();
  static {
  ...
  private static final Map<Byte, DataType> DATA_TYPES = new HashMap<Byte, DataType>();
  static {
    for (DataType type : DataType.values()) {
  ...
  private final Integer _minSize;
  /** default size in bytes for var length columns */
  private final Integer _defaultSize;
  ...
  /** min scale value */
  private final Integer _minScale;
  /** the default scale value */
  private final Integer _defaultScale;
  /** max scale value */
  private final Integer _maxScale;
  /** min precision value */
  private final Integer _minPrecision;
  /** the default precision value */
  private final Integer _defaultPrecision;
  /** max precision value */
  private final Integer _maxPrecision;
  ...
  public int getSQLType() throws SQLException {
    ...
    throw new SQLException("Unsupported data type: " + this);
  }
