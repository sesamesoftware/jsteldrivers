...
public abstract class ComplexValueForeignKey extends Number
{
  ...
  public abstract void updateMultiValue(SingleValue value)
    throws IOException;

  public abstract void deleteMultiValue(SingleValue value)
    throws IOException;

  public abstract UnsupportedValue addUnsupportedValue(Map<String,?> values)
    throws IOException;

  public abstract void updateUnsupportedValue(UnsupportedValue value)
    throws IOException;

  public abstract void deleteUnsupportedValue(UnsupportedValue value)
    throws IOException;
